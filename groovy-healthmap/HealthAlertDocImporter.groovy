...
String authKey = cliConfig.getOptionValue("k", "dd05dafd8ed157eb70d84c4d6485acaf")
...
html =html.replaceAll("[^a-zA-Z0-9 ,;_!\\?\\.\\\\(\\)\\/\\:\\-\\'\\t\\n\\r\\+\\|©]"," ")

	builder.with
	{
		healthMapAlertDocument(id: "HealthMapAlert_" + alert.hashCode(),
				externalId: "HealthMapAlert_" + alert.hashCode(),
				label: (alert.getTitle() == null || alert.getTitle().length() == 0) ? "Not Available" : alert.getTitle(),
